...
var i1 = document.querySelector("#f-item1");
var i2 = document.querySelector("#f-item2");
var i3 = document.querySelector("#f-item3");
var i4 = document.querySelector("#f-item4");
var i5 = document.querySelector("#f-item5");
var i6 = document.querySelector("#f-item6");
...
i6.addEventListener("mouseover", ()=>{ imgnav.src = "../image/samsung-galaxy-z-fold4-5g.jpg";} );
